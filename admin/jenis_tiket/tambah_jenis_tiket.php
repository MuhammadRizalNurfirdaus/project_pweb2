...
$page_title = "Tambah Jenis Tiket Baru";
include_once __DIR__ . '/../../template/header_admin.php';

// Ambil data form dari session untuk repopulasi jika ada error sebelumnya
$nama_layanan_val = $_SESSION['form_data_jenis_tiket']['nama_layanan_display'] ?? '';
$tipe_hari_val = $_SESSION['form_data_jenis_tiket']['tipe_hari'] ?? '';
$harga_val = $_SESSION['form_data_jenis_tiket']['harga'] ?? '';
$deskripsi_val = $_SESSION['form_data_jenis_tiket']['deskripsi'] ?? '';
$wisata_id_val = $_SESSION['form_data_jenis_tiket']['wisata_id'] ?? '';
$aktif_val = $_SESSION['form_data_jenis_tiket']['aktif'] ?? 1; // Default aktif saat tambah

// Hapus data form dari session setelah digunakan
unset($_SESSION['form_data_jenis_tiket']);

// Ambil daftar wisata untuk dropdown (opsional, jika jenis tiket terikat ke wisata)
...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Form Tambah Jenis Tiket Baru</h5>
    </div>
    <div class="card-body">
        <?php display_flash_message(); ?>

        <form action="<?= $base_url ?>admin/jenis_tiket/proses_tambah_jenis_tiket.php" method="POST" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="tipe_hari" name="tipe_hari" required>
                        <option value="" disabled <?= empty($tipe_hari_val) ? 'selected' : '' ?>>-- Pilih Tipe Hari --</option>
